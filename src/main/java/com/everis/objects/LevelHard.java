 ...
 * 
 * Clase de la dificultad Difícil.
 * 
 * @author esmer
 *
 */
public class LevelHard implements Levels {

	// Onjeto encargada de concatenar varios strings.
	...
	public void shoot(Map<Integer, Integer> map) {
		try {
			...
			System.err.println("[ERROR]:: El valor introducido no está permitido.");
		}
	...
	public void remaining(Map<Integer, Integer> map) {
		...
		sb.append("Tiene ").append(map.size()).append(" tiros restantes!!!");
		System.out.println(sb.toString());
		sb.setLength(0);
	...
	public void rules() {
		...
		sb.append("-------------------REGLAS------------------- \n")
				...
				.append("Según la dificultad elegida tendrá mas o menos \n objetivos y tiros. \n")
